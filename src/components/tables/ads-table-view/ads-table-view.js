...
const headCells = [
    ...
    { id: 'savesListensRate', align: 'right',  label: 'SLR', tooltip: 'Saves/Listens Rate. Конверсия из прослушиваний в добавления' },
    { id: 'streams', align: 'right',  label: 'Стримы', tooltip: 'Приблизительный расчет количества стримов из статистики кампании. Может не совпадать с действительностью' },
